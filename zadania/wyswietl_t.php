...
<body>
    ...
    echo "<table>";
    echo "<tr> <th> ID </th> <th> Tytul </th> <th> Gatunek </th> <th> Rok </th> <th> Ocena </th> </tr>";

    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>" . "<td>" . $row["id"] . "</td>" . "<td>" . $row["tytul"] . "</td>" . "<td>" . $row["gatunek"] . "</td>" . "<td>" . $row["rok"] . "</td>" . "<td>" . $row["ocena"] . "</td>" . "</tr>";
        }
    } else {
        echo "0 results";
    }
